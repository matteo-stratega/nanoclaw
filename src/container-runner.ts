...
function buildVolumeMounts(
  ...
  // Per-group env dir to isolate credentials (e.g., N8N keys only for n8n-expert)
  ...
  // Add per-group extra env vars (e.g., N8N_API_URL, N8N_API_KEY)
  if (group.containerConfig?.extraEnv) {
    for (const [key, value] of Object.entries(group.containerConfig.extraEnv)) {
